...
dat <- read_excel("C:\\Users\\walkera\\OneDrive - Nexus365\\Documents\\PhD\\AGDS\\Pharmacogenomics\\All_results.xlsx", sheet = 9) %>%
  fill(Threshold, ReferenceTerm, Outcome, Total_N, .direction = "down")

dat <- dat %>% filter(Term != "AGE" & Term != "SEX" & ReferenceTerm == "SSRI:Sertraline" & Term != "SSRI:Sertraline",
...
ggsave("C:\\Users\\walkera\\OneDrive - Nexus365\\Documents\\PhD\\AGDS\\Pharmacogenomics\\4. Associations\\3. NonPGS\\Results\\Figures\\PharmaceuticalMetrics_QuantitativeAssociations.png", 
...
#-- Read in results in which the dependent variable is quantitative
dat <- read_excel("C:\\Users\\walkera\\OneDrive - Nexus365\\Documents\\PhD\\AGDS\\Pharmacogenomics\\All_results.xlsx", sheet = "Table11") %>%
  rename(
    Threshold = threshold,
...
p
ggsave("C:\\Users\\walkera\\OneDrive - Nexus365\\Documents\\PhD\\AGDS\\Pharmacogenomics\\4. Associations\\3. NonPGS\\Results\\Figures\\ClinicalFeatures_QuantitativeAssociations.png", 
       plot = p, device = "png", width = 500, height = 400, units = "mm")
...
#-- Read in results in which the dependent variable is quantitative
dat <- read_excel("C:\\Users\\walkera\\OneDrive - Nexus365\\Documents\\PhD\\AGDS\\Pharmacogenomics\\All_results.xlsx", sheet = 7) %>%
...
ggsave("C:\\Users\\walkera\\OneDrive - Nexus365\\Documents\\PhD\\AGDS\\Pharmacogenomics\\4. Associations\\3. NonPGS\\Results\\Figures\\MDDSymptoms_BinaryAssociations.png", 
       plot = p, device = "png", width = 220, height = 250, units = "mm", dpi = 600)
...
ggsave("C:\\Users\\walkera\\OneDrive - Nexus365\\Documents\\PhD\\AGDS\\Pharmacogenomics\\4. Associations\\3. NonPGS\\Results\\Figures\\ClinicalFeatures_BinaryAssociations.png", 
       plot = p, device = "png", width = 500, height = 400, units = "mm")
...
ggsave("C:\\Users\\walkera\\OneDrive - Nexus365\\Documents\\PhD\\AGDS\\Pharmacogenomics\\4. Associations\\3. NonPGS\\Results\\Figures\\Comorbidities_BinaryAssociations.png", 
